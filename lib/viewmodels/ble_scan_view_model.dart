...
class BleScanViewModel extends ChangeNotifier {
  ...
  final _advServiceUuid = '0000aa0d-0000-1000-8000-00805f9b34fb';
  ...
  Lw006DeviceSession? _connectedSession;

  Lw006DeviceSession? get connectedSession => _connectedSession;
  ...
  Future<Lw006DeviceSession> connectDevice({
    required BuildContext context,
    ...
    final granted = await _requestPermissions(context);
    if (!granted) {
      throw Lw006ProtocolException('Please allow Bluetooth connect permission first.');
    }
