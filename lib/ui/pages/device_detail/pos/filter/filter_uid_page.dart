...
class _FilterUidPageState extends State<FilterUidPage> {
  ...
  Future<void> _load() async {
    await runWithBleLoading(context, () async {
      ...
      _namespace.text = Lw006ParamHelpers.bytesToHex(results[1].data);
      _instance.text = Lw006ParamHelpers.bytesToHex(results[2].data);
      setState(() {});
    });
  }
  ...
  Future<void> _save() async {
    ...
    await runWithBleLoading(context, () async {
      ...
      final ok = (await Future.wait([
        api.writeFilterEddystoneUidNamespace(Lw006ParamHelpers.hexToBytes(_namespace.text.trim())),
        api.writeFilterEddystoneUidInstance(Lw006ParamHelpers.hexToBytes(_instance.text.trim())),
