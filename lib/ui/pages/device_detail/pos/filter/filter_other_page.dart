...
class _FilterOtherPageState extends State<FilterOtherPage> {
  ...
  Future<void> _load() async {
    await runWithBleLoading(context, () async {
      ...
      final relationship = Lw006ParamHelpers.uint8(results[1].data);
      for (final rule in Lw006DataCodec.decodeMacRules(results[2].data)) {
  ...
  Future<void> _save() async {
    ...
    await runWithBleLoading(context, () async {
      ...
      final ok = (await Future.wait([
        api.writeFilterOtherRules(Lw006DataCodec.encodeMacRules(_encodeRules())),
